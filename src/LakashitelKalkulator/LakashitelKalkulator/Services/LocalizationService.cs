...
public class LocalizationService : IStringLocalizer
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _resources = new()
    {
        ["hu"] = new Dictionary<string, string>
        {
            ...
            ["FinalSellingCostsPercentage"] = "Végső eladási költségek (%)",
            ["FinalSellingCostsPercentageTooltip"] = "Az ingatlan eladásakor és utolsó felújításkor felmerülő költségek az ingatlan végső értékének százalékában",
            ["InitialRent"] = "Kezdeti havi bérleti díj",
            ["InitialRentTooltip"] = "Havi bérleti díj amit kapsz a bérlőtől, évente inflációval nő",
            ["InitialEmptyMonths"] = "Kezdeti üres hónapok",
            ["InitialEmptyMonthsTooltip"] = "Felújítási idő, mielőtt bérbe tudod adni (hónapokban). Ebben az időszakban nem kapsz bérleti díjat.",
            ["EmptyMonthsPerYear"] = "Éves üres hónapok",
            ["EmptyMonthsPerYearTooltip"] = "Várható üres hónapok minden évben bérlőváltás miatt. Ebben az időszakban nem kapsz bérleti díjat.",
            ["Currency"] = "Pénznem",
            ["Calculate"] = "Számol",
            ["Results"] = "Eredmények",
            ...
            ["FinalSellingCosts"] = "Végső eladási költségek",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["FinalSellingCostsPercentage"] = "Final Selling Costs (%)",
            ["FinalSellingCostsPercentageTooltip"] = "Costs incurred when selling the property and final renovation, as a percentage of the final property value",
            ...
            ["InitialEmptyMonths"] = "Initial Empty Months",
            ["InitialEmptyMonthsTooltip"] = "Renovation time before you can rent out (in months). You don't receive rent during this period.",
            ["EmptyMonthsPerYear"] = "Empty Months Per Year",
            ["EmptyMonthsPerYearTooltip"] = "Expected empty months each year due to renter changes. You don't receive rent during these months.",
            ["Currency"] = "Currency",
            ["Calculate"] = "Calculate",
            ["Results"] = "Results",
            ...
            ["FinalSellingCosts"] = "Final Selling Costs",
            ["NetWorth"] = "Net Worth",
